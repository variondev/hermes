...
include(":hermes-bridge:hermes-bridge-redis:api")
include(":hermes-bridge:hermes-bridge-redis:jedis")
include(":hermes-bridge:hermes-bridge-redis:lettuce")
include(":hermes-bridge:hermes-bridge-redis:redisson")