...
public final class MessageCallbackSubscriber implements HermesListener {
    ...
    MessageCallbackSubscriber(final MessageCodec messageCodec, final MessageCallbackFacade messageCallbackFacade) {
    ...
    public void receive(final String channelName, final byte[] payload) {
        ...
        messageCallbackFacade.findByUniqueId(uniqueId).ifPresent(future -> {
            try {
